...
namespace ColorPickerMath.ColorTriangle
{
    public class RotatingColorTriangleMath : ColorPickerMathBase
    {
        private readonly ColorTriangleMath _colorTriangle = new ColorTriangleMath();
        ...
        {
            ColorTriangleMath.HSLToHSV(color, out float _, out float saturation, out float _);
